...
- the Arch `PKGBUILD` path is now checked in under `GlassToKey.Linux/packaging/arch`; the next distro-expansion checkpoint is validating this install/runtime story on a real Arch environment
