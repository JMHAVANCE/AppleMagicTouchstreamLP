...
- The repo now also carries a first Debian package skeleton under `packaging/linux/deb/`, and that path has been validated far enough to produce a `.deb` from the current publish outputs.
